...
namespace UnityEditor.Tilemaps
{
    ...
    public class GridBrush : GridBrushBase
    {
        ...
        public override void BoxFill(GridLayout gridLayout, GameObject brushTarget, BoundsInt position)
        {
            ...
            var positionArray = new NativeArray<Vector3Int>(count, Allocator.Temp);
            var tileArray = new Tilemap.TileArray(count, Allocator.Temp);
            var transformArray = new NativeArray<Matrix4x4>(count, Allocator.Temp);
            var colorArray = new NativeArray<Color>(count, Allocator.Temp);
            ...
            try
            {
                ...
                foreach (var location in position.allPositionsWithin)
                {
                    ...
                    positionArray[i] = location;
                    tileArray[i] = cell.tile;
                    transformArray[i] = cell.matrix;
                    colorArray[i] = cell.color;
                    i++;
                }
                map.SetTiles(positionArray, tileArray, colorArray, transformArray, false);
            }
            finally
            {
        ...
        public override void BoxErase(GridLayout gridLayout, GameObject brushTarget, BoundsInt position)
        {
            ...
            var positionArray = new NativeArray<Vector3Int>(listSize, Allocator.Temp);
            var tileArray = new Tilemap.TileArray(listSize, Allocator.Temp);
            var transformArray = new NativeArray<Matrix4x4>(listSize, Allocator.Temp);
            var colorArray = new NativeArray<Color>(listSize, Allocator.Temp);
        ...
        public class BrushCell
        {
            ...
            public override int GetHashCode()
            {
                ...
                unchecked
                {
                    hash = tile != null ? tile.GetEntityId().GetHashCode() : 0;
