...
namespace UnityEditor.Tilemaps
{
    internal class GridPalettesDropdown : PopupWindowContent
    {
        ...
        public override void OnGUI(Rect rect)
        {
            ...
            var linkedPalette = GridTargetBrushSync.instance.GetLinkedPalette(GridPaintingState.scenePaintTarget);
                ...
                for (int i = 0; i <= maxIndex; ++i)
                {
                    ...
                    switch (evt.type)
                    {
                        case EventType.Repaint:
                            ...
                            var palette = m_ItemProvider.GetItem(i) as GameObject;
                            var hasTarget = palette != null && palette == linkedPalette;
                            ...
                            s_Styles.menuItem.Draw(itemRect, tname, hover, false, i == selectedIndex, false);
                            if (hasTarget)
                            {
