...
namespace UnityEditor.Tilemaps
{
    ...
    public sealed partial class TilePaletteActivePalettePopup : PopupField<GameObject>
    {
        ...
        {
            return new TilePaletteActivePaletteDropdownMenu(m_Active, Mathf.FloorToInt(this.resolvedStyle.width));
        }
    ...
    [EditorToolbarElement(k_ToolbarId)]
    internal sealed class TilePaletteActivePaletteSyncToggle : EditorToolbarToggle
    {
        internal const string k_ToolbarId = "Tools/Tile Palette Active Palette Sync";

        private static readonly string k_ToolSettingsClass = "unity-tool-settings";
        private static readonly string k_ElementClass = "unity-tilepalette-activepalette-sync";

        private static readonly string k_TooltipText = L10n.Tr("Sync Active Palette");

        public Action<bool> ToggleChanged;

        public TilePaletteActivePaletteSyncToggle()
        {
            name = "Tile Palette Active Palette Sync";
        ...
        private void OnAttachedToPanel(AttachToPanelEvent evt)
        {
            GridTargetBrushSync.instance.tilemapPaletteTargetsChanged += UpdateToggleState;
        ...
        private void OnPaletteChanged(GameObject palette)
        {
            UpdateToggleState();
        }
        ...
        private void UpdateToggleState()
        {
            ...
            var hasTarget = GridTargetBrushSync.instance.HasTilemapPaletteTarget(sceneTarget, palette);
        ...
        protected override void ToggleValue()
        {
            ...
            if (value)
                GridTargetBrushSync.instance.AddTilemapPaletteTarget(sceneTarget, palette);
            else
                GridTargetBrushSync.instance.RemoveTilemapPaletteTarget(sceneTarget, palette);
