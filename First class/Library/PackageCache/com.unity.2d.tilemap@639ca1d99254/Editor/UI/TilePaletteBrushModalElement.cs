...
namespace UnityEditor.Tilemaps
{
    internal class TilePaletteBrushModalElement : VisualElement
    {
        ...
        private static readonly string leftToolbarUssClassName = brushesToolbarUssClassName + "-left";
        ...
        public TilePaletteBrushModalElement()
        {
            ...
            var leftToolbarElement = new VisualElement();
            leftToolbarElement.AddToClassList(leftToolbarUssClassName);

            string[] leftToolbarElements = new[]
            {
                TilePaletteBrushesPopupIcon.k_ToolbarId,
                TilePaletteBrushesPopup.k_ToolbarId,
                TilePaletteBrushesSyncToggle.k_ToolbarId
            };
            var leftToolbar = EditorToolbar.CreateOverlay(leftToolbarElements);
            leftToolbarElement.Add(leftToolbar);
