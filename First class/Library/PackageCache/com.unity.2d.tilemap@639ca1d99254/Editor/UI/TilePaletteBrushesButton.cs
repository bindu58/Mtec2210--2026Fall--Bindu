...
namespace UnityEditor.Tilemaps
{
    ...
    public sealed partial class TilePaletteBrushesButton : EditorToolbarDropdown
    {
        ...
        private const string k_IconPath = "Packages/com.unity.2d.tilemap/Editor/Icons/Tilemap.CustomBrush.png";
        ...
        {
            AbstractGenericMenu menu = new TilePaletteBrushesDropdownMenu(true, 0);
