...
namespace UnityEditor.Tilemaps
{
    ...
    public partial class TilePaletteElement : VisualElement
    {
        ...
        private static readonly string leftToolbarUssClassName = toolbarUssClassName + "-left";
        ...
        private static string[] k_LeftToolbarElements = new[]
        {
            ...
            , TilePaletteActivePaletteSyncToggle.k_ToolbarId
        };
        ...
        public TilePaletteElement()
        {
            ...
            leftToolbar.AddToClassList(leftToolbarUssClassName);
